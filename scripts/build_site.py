...
<header>
  ...
  <div class="controls">
    <button id="btn-play" class="tooltip active" data-tip="Space" aria-label="Play/Pause simulation">▶ Play</button>
    <button id="btn-step" class="tooltip" data-tip="Right Arrow" aria-label="Step one generation">⏭ Step</button>
    <button id="btn-clear" class="tooltip" data-tip="C" aria-label="Clear grid">⌫ Clear</button>
    <button id="btn-random" class="tooltip" data-tip="R" aria-label="Randomize grid">🎲 Random</button>
  </div>
  <div class="sep"></div>
